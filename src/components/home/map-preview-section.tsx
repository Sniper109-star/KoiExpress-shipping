...
const fallbackOrigin: [number, number] = [3.3792, 6.5244];
const fallbackDestination: [number, number] = [7.4951, 9.0579];
const fallbackDriver: [number, number] = [5.2, 7.7];
