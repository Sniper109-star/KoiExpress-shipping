    ...
    <main className="bg-background text-foreground">
      <section className="border-b border-border bg-secondary text-secondary-foreground">
        <div className="mx-auto flex max-w-7xl flex-col gap-12 px-5 py-20 md:px-8 md:py-28 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-3xl">
            <p className="mb-6 flex items-center gap-2 text-sm font-semibold uppercase tracking-[0.2em] text-primary-foreground/70"><span className="size-2 rounded-full bg-primary" />KoiExpress logistics</p>
      ...
      <section className="mx-auto max-w-7xl px-5 py-20 md:px-8 md:py-28">
        <div className="mb-10 flex flex-col justify-between gap-5 md:flex-row md:items-end">
          <div>
            <p className="mb-3 text-sm font-semibold uppercase tracking-[0.18em] text-primary">The KoiExpress fleet</p>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <article className="group overflow-hidden border border-border bg-card">
            <Image src="/unifet-delivery-van.png" alt="KoiExpress red delivery van" width={1200} height={900} className="aspect-[4/3] w-full object-cover transition-transform duration-500 group-hover:scale-105" />
          ...
          <article className="group overflow-hidden border border-border bg-card">
            <Image src="/unifet-freight-truck.png" alt="KoiExpress red freight truck" width={1200} height={900} className="aspect-[4/3] w-full object-cover transition-transform duration-500 group-hover:scale-105" />
          ...
          <article className="group overflow-hidden border border-border bg-card">
            <Image src="/unifet-cargo-aircraft.png" alt="KoiExpress red cargo aircraft" width={1200} height={900} className="aspect-[4/3] w-full object-cover transition-transform duration-500 group-hover:scale-105" />
