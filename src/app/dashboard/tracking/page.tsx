...
import { findShipment, getTrackingEvents, subscribeToShipment, type TrackingEvent, type TrackingShipment } from "@/lib/shipment-tracking";
...
function TrackingContent() {
  ...
  const loadShipment = useCallback(async (number: string) => {
    ...
    setError(null);
    try {
      const nextShipment = await findShipment(number);
      setShipment(nextShipment);
      setEvents(nextShipment ? await getTrackingEvents(nextShipment.id) : []);
